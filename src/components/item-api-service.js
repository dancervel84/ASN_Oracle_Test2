...
<LgfData>
    ...
    <ListOfItems>
        <item>
            <company_code>${itemData.company_code}</company_code>
            <item_alternate_code/>
            <part_a>${itemData.part_a}</part_a>
            <part_b/>
            <part_c/>
            <part_d/>
            <part_e/>
            ...
            <barcode>${itemData.barcode}</barcode>
            ...
            <max_case_qty>${itemData.max_case_qty}</max_case_qty>
            ...
            <sortable/>
            <min_dispatch_uom/>
            <product_life>${itemData.product_life || ''}</product_life>
            <percent_acceptable_product_life>0</percent_acceptable_product_life>
            <lpns_per_tier>${itemData.lpns_per_tier}</lpns_per_tier>
            <tiers_per_pallet>${itemData.tiers_per_pallet}</tiers_per_pallet>
            <velocity_code/>
            <req_batch_nbr_flg>${itemData.req_batch_nbr_flg}</req_batch_nbr_flg>
            <serial_nbr_tracking/>
            <regularity_code/>
            ...
            <case_oblpn_type/>
            <pack_oblpn_type/>
            <description_2>${itemData.description_2}</description_2>
            <description_3>ESENTTIA</description_3>
            <invn_attr_a_tracking/>
            <invn_attr_a_dflt_value/>
            <invn_attr_b_tracking/>
            <invn_attr_b_dflt_value/>
            <invn_attr_c_tracking/>
            <invn_attr_c_dflt_value/>
            <nmfc_code/>
            <conversion_factor/>
            ...
            <dummy_sku_flg/>
            <pack_with_wave_flg/>
            <batch_handling_receiving/>
            <expiry_handling_receiving/>
            <primary_uom_code>KG</primary_uom_code>
            <case_uom_code></case_uom_code>
            <pack_uom_code>KG</pack_uom_code>
